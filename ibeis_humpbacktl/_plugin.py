...
# ibs.ibeis_humpbacktl_hello_world() in this file, you can call
#
#     python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_hello_world:0
#
...
#
#     python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_hello_world
#
# will run all of the tests for that function.  To run all tests for an entire file,
# you can simply call:
#
#     python -m ibeis_humpbacktl._plugin --allexamples
#
...
#
#     python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_file_download:1 --profile
#
...
# something like this:
#
#     **[TEST.FINISH] ibeis_humpbacktl_file_download -- SUCCESS
#     [util_io] * Writing to text file: timeings.txt
#     L_____________________________________________________________
#     +-------
#     | finished testing fpath='ibeis_humpbacktl/ibeis_humpbacktl/_plugin.py'
#     | passed 1 / 1
#     L-------
#     Dumping Profile Information
#      -1.00 seconds - None                                             :None:None
#       0.14 seconds - ibeis_humpbacktl_file_download:ibeis_humpbacktl/ibeis_humpbacktl/_plugin.py:536
...
#     587         2     136968.0  68484.0     99.9          file_filepath = ut.grab_file_url(file_url, appname='ibeis_humpbacktl', check_hash=True)
#     588
...
# that uses ut.embed() in the ibs.ibeis_humpbacktl_hello_world()
...
@register_ibs_method
@register_api('/api/plugin/humpbacktl/helloworld/', methods=['GET'])
def ibeis_humpbacktl_hello_world(ibs):
    r"""
    A "Hello world!" example for the IBEIS HumpbackTL plug-in.
    ...
    CommandLine:
        ...
        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_hello_world:1

    RESTful:
        Method: GET

        URL:    /api/plugin/humpbacktl/helloworld/
    ...
    Example0:
        ...
        >>> dbdir = sysres.ensure_testdb_humpbacktl()
        >>> ibs = ibeis.opendb(dbdir=dbdir)
        >>> resp = ibs.ibeis_humpbacktl_hello_world()
        >>>
        ...
        >>> })
        [ibeis_humpbacktl] hello world with IBEIS controller <IBEISController(testdb_identification) with UUID 1654bdc9-4a14-43f7-9a6a-5f10f2eaa279>
        {
            'annotations': 70,
    ...
    """
    args = (ibs, )
    resp = '[ibeis_humpbacktl] hello world with IBEIS controller %r' % args
    return resp


@profile
@register_ibs_method
def ibeis_humpbacktl_file_download(file_url):
    r"""
    ...
    CommandLine:
        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_file_download

        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_file_download:0

        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_file_download:1

    Example0:
        >>> # ENABLE_DOCTEST
        >>> from ibeis_humpbacktl._plugin import *  # NOQA
        >>> import utool as ut
        >>> file_url = 'https://cthulhu.dyn.wildme.io/public/data/lena.png'
        >>> file_filepath = ibeis_humpbacktl_file_download(file_url)
    ...
    Example1:
        ...
        >>> file_filepath_ = ibeis_humpbacktl_file_download(file_url)
    ...
    with ut.Timer() as timer:
        file_filepath = ut.grab_file_url(file_url, appname='ibeis_humpbacktl', check_hash=True)
...
class IdentificationExampleImageHashConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_humpbacktl._plugin --test-IdentificationExampleImageHashConfig

        python -m ibeis_humpbacktl._plugin --test-IdentificationExampleImageHashConfig:0

        python -m ibeis_humpbacktl._plugin --test-IdentificationExampleImageHashConfig:1
...
@register_preproc_image(
    ...
    fname='humpbacktl',
    chunksize=4)
def ibeis_humpbacktl_image_hash(depc, gid_list, config):
    r"""
    ...
    "_ibsdb/_ibeis_cacahe/humpbacktl.sqlite", as defined by the
    ...
    CommandLine:
        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_image_hash
...
class IdentificationExampleImageHashSumConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_humpbacktl._plugin --test-IdentificationExampleImageHashSumConfig
...
@register_preproc_image(
    ...
    fname='humpbacktl',
    chunksize=100)
def ibeis_humpbacktl_image_hash_sum(depc, image_hash_rowid_list, config):
    r"""
    ...
    CommandLine:
        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_image_hash_sum
...
class IdentificationExampleImageHashProdConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_humpbacktl._plugin --test-IdentificationExampleImageHashProdConfig
...
@register_preproc_image(
    ...
    fname='humpbacktl',
    chunksize=100)
def ibeis_humpbacktl_image_hash_prod(depc, image_hash_rowid_list, config):
    r"""
    ...
    CommandLine:
        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_image_hash_prod
...
class IdentificationExampleOracleRequest(dt.base.VsOneSimilarityRequest):  # NOQA
    ...
    CommandLine:
        python -m ibeis_humpbacktl._plugin --test-IdentificationExampleOracleRequest
...
class IdentificationExampleOracleConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_humpbacktl._plugin --test-IdentificationExampleOracleConfig
...
@register_preproc_annot(
    ...
    fname='humpbacktl',
    chunksize=None)
def ibeis_humpbacktl_oracle(depc, qaid_list, daid_list, config):
    r"""
    ...
    CommandLine:
        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_oracle:0

        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_oracle:0 --show

        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_oracle:1

        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_oracle:2

        python -m ibeis_humpbacktl._plugin --test-ibeis_humpbacktl_oracle:3
