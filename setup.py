...
KEYWORDS            = ['ibeis', 'plugin', 'humpbacktl', 'identification', 'wildbook', 'ia']
...
def write_version_py(filename=os.path.join('ibeis_humpbacktl', 'version.py')):
    cnt = '''
